...
def build_config() -> fdl.Config[ExperimentConfig]:
    ...
    architecture = fdl.Config(
        ...
        decoder_channels=(512, 256, 128, 96),
        pretrained=True,
        dropout=0.05,
        freeze_stem=False,
        use_aspp=True,
    ...
    data_module = fdl.Config(
        ...
        batch_size=6,
        num_workers=8,
        train_transform=build_train_transform(image_size=512),
        eval_transform=build_eval_transform(),
        segmentation_root="data/FungiTastic/SegmentationDataset-Mini-500p-512px",
    )
